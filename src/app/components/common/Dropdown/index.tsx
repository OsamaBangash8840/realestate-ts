          ...
          <MenuItem key={index}>
            {({ active }) => {
              ...
              return option.href ? (
                <a
                  href={option.href}
                  className="block px-4 py-2 text-sm border-b last:border-b-0 border-gray-100 transition bg-black text-white hover:bg-gray-800"
                >
                  {content}
                </a>
              ) : (
                <button
                  ...
                  className="block w-full text-left px-4 py-2 text-sm border-b last:border-b-0 border-gray-100 transition bg-black text-white hover:bg-gray-800"
                >
                  {content}
                </button>
              )
